...
<div class="main-content blogpost-bg">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="breadcrum"><a href="blogpost.php">Home</a>><a href="pree.php">Press Release</a></div>
				</div>
			</div>
		</div>
 ...
 <?php 
			...
			$ArrayUser = $ObjPressRelease->GetPressRelease($id);
			$i=1;
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8 col-md-8">
					...
					<div class="blogpview">
						<figure><img src="<?php echo $configVars['ImageUrlPath'];?>blog-images/<?php echo $row['image'];?>" height="300" width="500" alt=""></figure>
