...
if(empty($_SESSION['UserId'])) {
 ...
 //  		//echo'<pre>';print_r($passkey); die;
	...
	if(isset($_POST['submit'])){
       ...
       // $ValidAmount  = $ObjBuycoins->ValidAmount($amount);
							...
							<form action="#" method="post">
								<div class="btcbox-row clearfix">
									...
									<div class="btcbox-m inputconverter pull-right">
											...
											<input type="text" name="amount" id="amount" placeholder="USD15.00" onblur="javascript:function1(<?php echo $_SESSION['UserId'];?>);">
...
return httpObj;
 ...
 function function1(UserId) { 
       ...
       url = 'http://localhost/Coinxoom/checkcashwallet.php?UserId='+UserId+'&amount='+amount;
	  // alert(url);
