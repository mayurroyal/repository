...
?>
                           		<form action="" method="post">
										...
										<li class="clearfix"><button type="submit" name="submit" id="submit" class="btn-account-ver">Verify Account</button></li>
									</ul>
...
{     
    ...
    {
       $sql1 = "UPDATE user_verification SET mobile_verification ='N' WHERE id = 2";
