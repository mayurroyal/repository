...
if (isset($_POST['submit']) && $_POST['submit'] != '') {
	...
	//echo'<pre>';print_r($ArrayUser[0]['Id']); die;
  ...
  /*
   ...
   $Email      = $_POST['Email'];
    ...
    if($Email == 'user' && $Password == 'password'){
        session_start();
        $_SESSION['Email'] = $Email; //This is storing the validated username in session
    }else{
  ...
  */
   ...
   if(!empty($ArrayUser[0]['UserName'])){
	
	   $_SESSION['UserId'] = $ArrayUser[0]['Id'];
		$_SESSION['Email']  = $ArrayUser[0]['Email'];
		$_SESSION['UserName']  = $ArrayUser[0]['UserName'];
					...
					<div class="login-row">
						<form method="post">
							...
							<ul class="logininput-row">
								<li>
									<div class="log-input"><input type="text" name="Email" required="required" placeholder="Email Address"><span class="login-icon"><i class="fa fa-envelope"></i></span></div>
								<li>
								<li>
									<div class="log-input password-width">
										<input type="password" name="Password" placeholder="Password" required="required" class="password-s"> 
								...
								<li>
									<div class="checkbox1">
								   	...
								   	<a hrer="#" class="for-got">Forgot Password?</a>
								</li>
								<li>
