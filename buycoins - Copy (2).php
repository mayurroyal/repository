...
if(empty($_SESSION['UserId'])) {
    ...
    if(isset($_POST['submit'])){
        ...
        if($_SESSION['Cash_wallet'] < $amount){
            echo'<pre>';print_r("Un-sufficient amount"); die;
        }
                                 ...
                                 <!--div class="btcbox-row clearfix">
                                    ...
                                    <div class="btcbox-row clearfix">
                                        ...
                                        <div class="btcbox-m inputconverter pull-right">
                                            ...
                                            <button type="submit" disabled id="submitButton" name="submit" class="resume-btn buy2btn">BUY money</button>
