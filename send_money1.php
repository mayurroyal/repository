						...
						<div class="account-info">
                            ...
                            <div class="btcbox-row clearfix">
								...
								<div class="btcbox-m pull-right">
									<select name="send_form_wallet" onchange='CheckColors(this.value);'> 
                            ...
                            <div class="btcbox-row clearfix">
								...
								<div class="btcbox-m inputconverter pull-right">
									 <input type="text" name="amount" id="send_form_wallet" placeholder="BTC 15.00" style='display:none;'/>
                                     <input type="text" name="amount" id="send_form_wallet1" placeholder="USD 15.00" style='display:none;'/>
								</div>
							</div>
...
function CheckColors(val){
 var element=document.getElementById('send_form_wallet');
 if(val=='select'||val=='Bitcoin Wallet')
   element.style.display='block';
 else  
   element.style.display='none';
   
   
   var element1=document.getElementById('send_form_wallet1');
   
    if(val=='select'||val=='Cash Wallet')
